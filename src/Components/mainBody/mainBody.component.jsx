...
import TestScroll from '../video-scroll/TestScroll';
// import TestScrollWithCanvas from '../video-scroll/TestScrollWithCanvas';
// import NewScrollYT from '../video-scroll/NewScrollYT';
...
const MainBody = () => {
    ...
    useEffect(() => {
        ...
        window.addEventListener('scroll', function () {
            ...
            if (scrollY > 100 && scrollY < (1.2 * threshold)) {
